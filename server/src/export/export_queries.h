...
namespace export_queries
{
    ...
    /**
     * @brief 导出 blog_categories 表为 JSON 数组。
     * @param txn 当前事务。
     * @return JSON 数组。
     */
    ...
    /**
     * @brief 导出 blog_tag_relations 关联表为 JSON 数组。
     * @param txn 当前事务。
     * @return JSON 数组。
     */
    ...
    /**
     * @brief 导出 blog_categories_relations 关联表为 JSON 数组。
     * @param txn 当前事务。
     * @return JSON 数组。
     */
    [[nodiscard]] auto query_blog_categories_relations(pqxx::work& txn) -> nlohmann::json;
